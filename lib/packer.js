class Packer {
    ...
    pack (rects) {
        ...
        rects.forEach(rect => {
            const container = this.findContainer(this.root, rect.width, rect.height)
            rect.pack = container
                ? this.splitContainer(container, rect.width, rect.height)
    ...
    expandRight (width, height) {
        ...
        return container
            ? this.splitContainer(container, width, height)
            : null
    }
